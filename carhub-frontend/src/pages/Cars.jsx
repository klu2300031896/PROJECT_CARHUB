            ...
            {cars.map((car) => (
              <div key={car.id} className="card" style={{ padding: 12 }}>
                <div style={{ height: 160, overflow: "hidden", borderRadius: 8, marginBottom: 10 }}>
                  <img src={car.imageUrl ? `http://localhost:8080${car.imageUrl}` : "https://via.placeholder.com/400x200?text=No+Image"} alt="car" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
