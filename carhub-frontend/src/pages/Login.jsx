...
function Login() {
  ...
  const login = async () => {
    try {
      ...
      Swal.fire({ icon: "error", title: "Error", text: err?.response?.data || "Login failed", confirmButtonColor: "#d4af37", timer: 2200, showConfirmButton: false });
    }
  };
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-brand">
          ...
          <p style={{ marginTop: 10, color: "#fff", fontWeight: 600 }}>Login to continue</p>
        </div>
