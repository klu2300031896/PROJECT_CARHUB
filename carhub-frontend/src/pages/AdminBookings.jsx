  ...
  const renderBookingCard = (b) => (
    <div key={b.id} className="card" style={{ padding: 14 }}>
      <div style={{ height: 160, overflow: "hidden", borderRadius: 10, marginBottom: 12 }}>
        <img
          src={b.car.imageUrl ? `https://carhub-backend-production-39e4.up.railway.app:8080${b.car.imageUrl}` : "https://via.placeholder.com/400x220?text=No+Image"}
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
        ...
        <span style={{ color: "#f5d76e" }}>{b.userEmail}</span>
      </div>
      <p style={{ color: "#94a3b8", margin: "3px 0" }}>Car ID: {b.car?.id}</p>
      <p style={{ color: "#cbd5e1", margin: "3px 0" }}>Start: {b.startDate}</p>
      <p style={{ color: "#cbd5e1", margin: "3px 0" }}>End: {b.endDate}</p>
      <p style={{ color: "#f5d76e", margin: "6px 0 0", fontWeight: 700 }}>Total: Rs. {b.totalPrice}</p>
          ...
          <>
            <div className="section" style={{ marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                <h2 style={{ margin: 0, color: "#22c55e" }}>Confirmed Bookings</h2>
                <span style={{ color: "#cbd5e1" }}>{confirmedBookings.length}</span>
              </div>
            ...
            <div className="section" style={{ marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                <h2 style={{ margin: 0, color: "#f87171" }}>Cancelled Bookings</h2>
                <span style={{ color: "#cbd5e1" }}>{cancelledBookings.length}</span>
              </div>
            ...
            <div className="section">
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                <h2 style={{ margin: 0, color: "#cbd5e1" }}>Completed Bookings</h2>
                <span style={{ color: "#cbd5e1" }}>{completedBookings.length}</span>
              </div>
