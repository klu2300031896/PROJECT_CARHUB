            ...
            {cars.map((car) => (
              <div className="card" key={car.id} style={{ padding: 12 }}>
                <div style={{ height: 150, overflow: "hidden", borderRadius: 8, marginBottom: 10 }}>
                  <img src={car.imageUrl ? `http://carhub-backend-production-39e4.up.railway.app:8080${car.imageUrl}` : "https://via.placeholder.com/250x150?text=No+Image"} alt="car" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
